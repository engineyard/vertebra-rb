  ...
  module Protocol
    ...
    class Server
      ...
      def receive_request(iq)
        ...
        #@op = Vertebra::deep_copy(iq.node.get_child('op'))
        @iq = iq
      ...
      def process_authorization
        ...
        answer = @agent.op('/security/authorize', @agent.herault_jid, *res)

        if answer['response'] == 'authorized'
          process_authorized
        else
